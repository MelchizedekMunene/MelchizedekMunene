...
I'm a **Software Engineer** from **Nairobi, Kenya** with a passion for building products that are fast, scalable, and genuinely useful. I specialise in full-stack web and mobile development — from clean React UIs to resilient Node.js backends and real-world payment integrations.

When I'm not shipping code, I'm sharing what I know as an **ICT Trainer at Beacon of Hope Academy**, teaching the next generation of developers the fundamentals of programming and computing.
...
| Achievement | Impact |
|---|---|
| 🛒 Built full-stack e-commerce platform for **Shamah Hardware** | +25% customer reach · +40% online traffic |
| 💳 Resolved live **Pesapal payment gateway** failure in 48 hours | Saved **KES 500K+/month** in transactions |
| 🤖 **Distributed AI Hackathon** — TensorFlow & PyTorch optimization | Reduced ML data processing time by **35%** |
...
- 👨‍🏫 **Teaching** programming fundamentals & ICT at Beacon of Hope Academy
- 📚 **Deepening** expertise in cloud-native architectures and microservices
...
I'm available for **freelance projects**, **contract work**, and **full-time engineering roles** — remote or Nairobi-based.
